            ...
            <div class="flex-1">
                ...
                <div v-else class="flex flex-none md:justify-between rounded-lg content-center">
                    <div>
                        ...
                        <div class="mt-20 text-4xl text-gray-600 font-bold font-montserrat">{{ latestApod.title }}</div>
                        <div class="text-sm text-gray-500 font-medium font-montserrat">{{ latestApod.date }}</div>
                        <button @click="goToDetail" class="hover:bg-slate-700 mt-5 font-medium px-4 py-2 bg-slate-800 text-white font montserrat border-none rounded-lg">Learn more</button>
                    </div>
                    <iframe class="w-1/2 h-80 rounded-lg" :src="latestApod.url" frameborder="0"></iframe>
                </div>
