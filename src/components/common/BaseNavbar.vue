    ...
    <div class="relative flex items-center justify-between h-16">
      ...
      <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
        <div class="flex-shrink-0 flex items-center">
          <img class="block mx-3 h-8 w-auto" :src="imageUrl" alt="Workflow">
          <div class="text-xl text-white font-light">DAILY ASTRO</div>
        </div>
        <div class="hidden sm:block sm:ml-6">
          <div class="flex space-x-4">
            ...
            <router-link to="/gallery" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">GALLERY</router-link>
...
const imageUrl = new URL('../../assets/logo2.svg', import.meta.url).href
